...
import com.gipl.imagepicker.utility.MediaUtility.FILE.createImageFile
import com.gipl.imagepicker.utility.MediaUtility.PROFILE_PHOTO
import com.gipl.imagepicker.utility.MediaUtility.getBitmap
import com.gipl.imagepicker.utility.MediaUtility.getFilePathFromUri
import com.gipl.imagepicker.utility.MediaUtility.insertImage
import java.io.File
...
class ImagePicker internal constructor(private val activity: Context) {
    ...
    private var iImagePickerError: IImagePickerError? = null
    ...
    fun setImagePickerError(iImagePickerError: IImagePickerError?) {
    ...
    fun onRequestPermissionsResult(grantResults: Array<Boolean>, requestCode: Int) {
        if (requestCode == CAMERA_PERMISSION_REQUEST) {
            ...
            if (grantResults.isNotEmpty() &&
                ...
                startGallary()
            } else iImagePickerError?.onError(
                ImageErrors(
                    "Permission is disable by user",
                    ImageErrors.PERMISSION_ERROR
                )
